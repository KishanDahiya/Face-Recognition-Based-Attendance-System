...
class Face_Recognition:
    def __init__(self,root):
        ...
        b1_1=Button(f_lbl,text="Face Recognition",command=self.face_recog,font=("times new roman",20,"bold"),cursor="hand2",bg="lightblue",fg="black")
    ...
    def face_recog(self):
        def draw_boundary(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in features:
                ...
                if confidence>77:
                    cv2.putText(img,f"USN:{i}",(x,y-80),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),3)
                    ...
                    cv2.putText(img,f"Sem:{s}",(x,y-20),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),3)
